...
public:
	...
	static void Check(intervalGenerator &gen);
	...
	static void storeOldResult(vector<double> *old_pubMatchtime,int pubs, vector<double> *old_subMatchtime, int subs);
	static void storeNewResult(vector<double> *new_pubMatchtime,int pubs, vector<double> *new_subMatchtime, int subs);
	static void writeOldtp(int pubs, int subs, string filename);
	static void writeNewtp(int pubs, int subs, string filename);
	static void disdetail(string i);
